...
- Revalidar deadlines no ponto de uso e na entrega de resultados; a ordem de execucao de timers/microtasks nao pode autorizar trabalho tardio. Accounting global deve incluir handshakes direct e internos via relay.
- Escritas legitimas nao podem produzir bancos acima da quota aceita pelo loader. Migracoes somente fazem commit depois da validacao completa; objetos SQLite inesperados devem ser rejeitados sem filtros de prefixo ambiguos.
